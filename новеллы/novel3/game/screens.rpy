...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(72, 108, 1202, 75) action Start()
        hotspot(72, 295, 255, 70) action Start()
        hotspot(72, 381, 364, 70) action ShowMenu("load")
        hotspot(72, 463, 404, 70) action ShowMenu("preferences")
        hotspot(72, 552, 285, 70) action ShowMenu("about")
        hotspot(72, 639, 265, 70) action ShowMenu("help")
        hotspot(72, 725, 231, 70) action Quit(confirm=True)
